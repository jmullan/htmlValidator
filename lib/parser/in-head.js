...
// @discussion: http://dev.w3.org/html5/spec/tokenization.html#parsing-main-inhead
...
exports.start = function (token) {
    ...
    case 'meta':
        ...
        return;
    case 'title':
        // FIXME: Follow the generic RCDATA element parsing algorithm. http://dev.w3.org/html5/spec/tokenization.html#generic-rcdata-element-parsing-algorithm
        this.insertElement(token);
    ...
    case 'noframes':
    case 'style':
        // TODO: Follow the generic raw text element parsing algorithm. http://dev.w3.org/html5/spec/tokenization.html#generic-raw-text-element-parsing-algorithm
