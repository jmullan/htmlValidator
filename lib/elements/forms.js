...
// @discussion: http://dev.w3.org/html5/spec/forms.html#the-form-element
exports.form = {
...
// @discussion: http://dev.w3.org/html5/spec/forms.html#the-fieldset-element
exports.fieldset = {
    attrs: _.extend({}, common.attrs, {
...
// @discussion: http://dev.w3.org/html5/spec/forms.html#the-legend-element
exports.legend = {
    attrs: common.attrs,
...
// @discussion: http://dev.w3.org/html5/spec/forms.html#the-label-element
exports.label = {
    attrs: _.extend({}, common.attrs, {
        form: { type: datatypes.IDREF }, // TODO: must be the id of a form
...
// @discussion: http://dev.w3.org/html5/spec/the-input-element.html
exports.input = {
    attrs: _.extend({}, common.attrs, {
        ...
        max: { type: datatypes.string }, // TODO: dependent on the type attribute - http://dev.w3.org/html5/spec/common-input-element-attributes.html#attr-input-max
        maxlength: { type: datatypes['integer-non-negative'] },
        min: { type: datatypes.string }, // TODO: dependent on the type attribute - http://dev.w3.org/html5/spec/common-input-element-attributes.html#attr-input-max
...
// @discussion: http://dev.w3.org/html5/spec/the-button-element.html
exports.button = {
    attrs: _.extend({}, common.attrs, {
        autofocus: { type: ['autofocus', null] }, // TODO: There must not be more than one element in the document with the autofocus attribute specified.
        disabled: { type: ['disabled', null] },
...
// @discussion: http://dev.w3.org/html5/spec/the-select-element.html
exports.select = {
    attrs: _.extend({}, common.attrs, {
        autofocus: { type: ['autofocus', null] }, // TODO: There must not be more than one element in the document with the autofocus attribute specified.
        disabled: { type: ['disabled', null] },
...
// @discussion: http://dev.w3.org/html5/spec/the-datalist-element.html
exports.datalist = {
    attrs: common.attrs,
...
// @discussion: http://dev.w3.org/html5/spec/the-optgroup-element.html
exports.optgroup = {
    attrs: _.extend({}, common.attrs, {
        disabled: { type: ['disabled', null] },
...
// @discussion: http://dev.w3.org/html5/spec/the-option-element.html
exports.option = {
    attrs: _.extend({}, common.attrs, {
        disabled: { type: ['disabled', null] },
...
// @discussion: http://dev.w3.org/html5/spec/the-textarea-element.html
exports.textarea = {
    attrs: _.extend({}, common.attrs, {
        autofocus: { type: ['autofocus', null] }, // TODO: There must not be more than one element in the document with the autofocus attribute specified.
...
// @discussion: http://dev.w3.org/html5/spec/the-keygen-element.html
exports.keygen = {
    attrs: _.extend({}, common.attrs, {
        autofocus: { type: ['autofocus', null] }, // TODO: There must not be more than one element in the document with the autofocus attribute specified.
...
// @discussion: http://dev.w3.org/html5/spec/the-output-element.html
exports.output = {
    attrs: _.extend({}, common.attrs, {
...
// @discussion: http://dev.w3.org/html5/spec/the-progress-element.html
exports.progress = {
    attrs: _.extend({}, common.attrs, {
        value: { type: datatypes.string },
...
// @discussion: http://dev.w3.org/html5/spec/the-meter-element.html
exports.meter = {
    attrs: _.extend({}, common.attrs, {
